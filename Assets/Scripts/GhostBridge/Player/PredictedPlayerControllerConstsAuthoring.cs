...
public class PredictedPlayerControllerConstsAuthoring : MonoBehaviour
{
    ...
    public float WalkSpeed { get; private set; } = 4.8f;

    [field: SerializeField, Tooltip("Sprint speed of the character in m/s")]
    public float SprintSpeed { get; private set; } = 6.8f;

    [field: SerializeField, Tooltip("Crouch speed of the character in m/s")]
    public float CrouchSpeed { get; private set; } = 3.2f;

    [field: SerializeField, Tooltip("Initial burst speed of slide in m/s")]
    public float SlideSpeed { get; private set; } = 9.0f;
    ...
    public float WalkSpeedChangeRate { get; private set; } = 20.0f;

    [field: SerializeField, Tooltip("Acceleration and deceleration while sprinting")]
    public float SprintSpeedChangeRate { get; private set; } = 25.0f;

    [field: SerializeField, Tooltip("Acceleration and deceleration while crouching")]
    public float CrouchSpeedChangeRate { get; private set; } = 20.0f;

    [field: SerializeField, Tooltip("Acceleration and deceleration while sliding")]
    public float SlideSpeedChangeRate { get; private set; } = 15.0f;
        ...
        AddComponent(entity, new PredictedPlayerControllerConsts
        {
            ControllerConsts = new FirstPersonController.ControllerConsts
            {
                ...
                Crouch = new FirstPersonController.ControllerConsts.StateConsts
                {
                    ...
                    LandingSpeedMult = 1f,
                    AnimationMotionScale = 0.3f,
                },

                Slide = new FirstPersonController.ControllerConsts.StateConsts
                {
                    Speed = authoring.SlideSpeed,
                    RotationSmoothTime = 0.5f,
                    SpeedChangeRate = authoring.SlideSpeedChangeRate,
                    LandingSpeedMult = 1f,
                    AnimationMotionScale = 0.1f,
                },
            }
        });
    }
