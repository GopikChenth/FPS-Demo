...
public struct PlayerInput
{
    ...
    public bool Prone => (InputFlags & (uint)InputFlag.Prone) != 0;
    public bool Slide => (InputFlags & (uint)InputFlag.Slide) != 0;
    public bool AimDownSights => (InputFlags & (uint)InputFlag.AimDownSights) != 0;
